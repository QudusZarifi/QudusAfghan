...
\033[1;94mFACEBOOK  Quduszarifi
                  
\033[1;92mFB PAGE   Quduszarkfk
...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓RED-Quduszarifi      ║║
║  GITHUB 💝💝💝 Quduszarifi(RK)   ║ ║
║ FACEBOOK 💝💝💝Afghan║ ║
║  ENJOY 💝💝💝Pak Cloning                ║ ║
 ...
 ╚══▀▀═╝  ╚═════╝ ╚═════╝  ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝     ╚═╝
                         ...
                         DON'T COPY MY SCRIPT
                                      RED-MAFIA          
                                        TNX(RK)
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓Quduszarifi (RK)                              ║
║  GITHUB 💝💝💝 Quduszarifi                             ║
║ FACEBOOK 💝💝💝QudusAfghan               ║
║  ENJOY 💝💝💝Pak Cloning                             ║
║   Note 💝💝💝Use Fastest Speed Net             ║
╚══──────────────────────────╝─══╝
"""
...
""")
CorrectUsername = "qudus"
CorrectPassword = "zarifi"
